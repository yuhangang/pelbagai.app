...
public nonisolated class Gemma4Model: Module, VLMModel, KVCacheDimensionProvider {
    ...
    private func getInputEmbeddings(
        ...
        if let pixelValues {
            ...
            var imageFeatures = visionTower(pixelValues, outputLength: imageTokenPositions)
