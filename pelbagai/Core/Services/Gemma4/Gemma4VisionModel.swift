...
final nonisolated class Gemma4ClippableLinear: Module {
...
final nonisolated class Gemma4VisionRMSNorm: Module {
...
final nonisolated class Gemma4VisionRMSNormNoScale: Module {
    let eps: Float
...
final nonisolated class Gemma4VisionPatchEmbedder: Module {
...
final nonisolated class Gemma4VisionAttention: Module {
    let config: Gemma4VisionConfiguration
...
final nonisolated class Gemma4VisionMLP: Module {
...
final nonisolated class Gemma4VisionTransformerBlock: Module {
...
final nonisolated class Gemma4VisionTransformerModel: Module {
...
final nonisolated class Gemma4VisionPooler: Module {
    let hiddenSize: Int
...
final nonisolated class Gemma4VisionModel: Module {
    let config: Gemma4VisionConfiguration
...
final nonisolated class Gemma4MultimodalProjector: Module {
